...
((global, factory) => {
    ...
    () => {
         ...
         */
        var fromUint8Array = (u8a, urlsafe) => {
            if (urlsafe === void 0) {
                urlsafe = false;
            }
         ...
         */
        var extendString = () => {
            var _add = (name, body) => Object.defineProperty(String.prototype, name, _noEnum(body));
        ...
        var extendUint8Array = () => {
            var _add = (name, body) => Object.defineProperty(Uint8Array.prototype, name, _noEnum(body));
            _add("toBase64", function (urlsafe) {
