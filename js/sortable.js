...
((global, factory) => {
            ...
            if (!IE11OrLess) {
                do {
                    if (
                        ...
                        top -= containerRect.top + Number.parseInt(css(container, "border-top-width"));
                        left -= containerRect.left + Number.parseInt(css(container, "border-left-width"));
                ...
                if (duration) {
                    ...
                    css(
                        ...
                        "transform " +
                            duration +
                            "ms" +
                            (this.options.easing ? " " + this.options.easing : " !important")
                    );
    ...
    var documentExists = typeof document !== "undefined",
        ...
        _detectDirection = function _detectDirection(el, options) {
            var elCSS = css(el),
                elWidth =
                    Number.parseInt(elCSS.width) -
                    Number.parseInt(elCSS.paddingLeft) -
                    Number.parseInt(elCSS.paddingRight) -
                    Number.parseInt(elCSS.borderLeftWidth) -
                    Number.parseInt(elCSS.borderRightWidth),
                ...
                firstChildWidth =
                    firstChildCSS &&
                    Number.parseInt(firstChildCSS.marginLeft) +
                        Number.parseInt(firstChildCSS.marginRight) +
                        getRect(child1).width,
                secondChildWidth =
                    secondChildCSS &&
                    Number.parseInt(secondChildCSS.marginLeft) +
                        Number.parseInt(secondChildCSS.marginRight) +
    ...
    Sortable.prototype =
        /** @lends Sortable.prototype */
        {
            ...
            _appendGhost: function _appendGhost() {
                ...
                if (!ghostEl) {
                    ...
                    css(
                        ghostEl,
                        "transform-origin",
                        (tapDistanceLeft / Number.parseInt(ghostEl.style.width)) * 100 +
                            "% " +
                            (tapDistanceTop / Number.parseInt(ghostEl.style.height)) * 100 +
                            "%"
                    );
                }
            },
            _onDragStart: function _onDragStart(
                ...
                this.cloneId = _nextTick(() => {
                    pluginEvent("clone", this);
                ...
                if (fallback) {
                    ...
                    on(document, "drop", this); // #1276 fix:
    ...
    Sortable.get = element => element[expando];
    /**
    ...
    Sortable.create = (el, options) => new Sortable(el, options); // Export
    ...
    var autoScroll = throttle((evt, options, rootEl, isFallback) => {
    ...
    function MultiDragPlugin() {
        ...
        MultiDrag.prototype = {
            ...
            dragStartGlobal: function dragStartGlobal(_ref6) {
                ...
                multiDragElements = multiDragElements.sort((a, b) => a.sortableIndex - b.sortableIndex);
                dragStarted = true;
            },
