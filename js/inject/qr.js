...
sue.apps.qr = {
    ...
    initUI: function () {
        ...
        const _time = Number.parseInt(new Date().getTime() / 1000);
        const _inputBox = sue.apps.domCreate("div", {
                setName: ["className"],
                setValue: ["qr_inputbox"],
            }),
            _eleBox = sue.apps.domCreate("div", null, null, "text-align:left;", null, null);
        // url
        const _domUrl = sue.apps.domCreate("input", {
                setName: ["className", "id", "name", "type"],
                setValue: ["qr_type_url", "qr_type_url_" + _time, "qr_type_" + _time, "radio"],
            }),
            _labelUrl = sue.apps.domCreate(
                "label",
                { setName: ["htmlFor"], setValue: ["qr_type_url_" + _time] },
                null,
                null,
                null,
                sue.apps.i18n("app_qr_url")
            ),
        ...
        // select text
        const _domSeltxt = sue.apps.domCreate("input", {
                setName: ["className", "id", "name", "type"],
                setValue: ["qr_type_seltxt", "qr_type_seltxt_" + _time, "qr_type_" + _time, "radio"],
            }),
            _labelSeltxt = sue.apps.domCreate(
                "label",
                { setName: ["htmlFor"], setValue: ["qr_type_seltxt_" + _time] },
                null,
                null,
                null,
                sue.apps.i18n("app_qr_seltxt")
            ),
        ...
        // select link
        const _domSellnk = sue.apps.domCreate("input", {
                setName: ["className", "id", "name", "type"],
                setValue: ["qr_type_sellnk", "qr_type_sellnk_" + _time, "qr_type_" + _time, "radio"],
            }),
            _labelSellnk = sue.apps.domCreate(
                "label",
                { setName: ["htmlFor"], setValue: ["qr_type_sellnk_" + _time] },
                null,
                null,
                null,
                sue.apps.i18n("app_qr_sellnk")
            ),
        ...
        // title
        const _domTitle = sue.apps.domCreate("input", {
                setName: ["className", "id", "name", "type"],
                setValue: ["qr_type_title", "qr_type_title_" + _time, "qr_type_" + _time, "radio"],
            }),
            _labelTitle = sue.apps.domCreate(
                "label",
                { setName: ["htmlFor"], setValue: ["qr_type_title_" + _time] },
                null,
                null,
                null,
                sue.apps.i18n("app_qr_title")
            ),
        ...
        // customer
        const _domCustomer = sue.apps.domCreate("input", {
                setName: ["className", "id", "name", "type"],
                setValue: ["qr_type_customer", "qr_type_customer_" + _time, "qr_type_" + _time, "radio"],
            }),
            _labelCustomer = sue.apps.domCreate(
                "label",
                { setName: ["htmlFor"], setValue: ["qr_type_customer_" + _time] },
                null,
                null,
                null,
                sue.apps.i18n("app_qr_customer")
            ),
        ...
        const _textarea = sue.apps.domCreate("textarea", {
            setName: ["className"],
            setValue: ["qr_inputarea"],
        });
        _textarea.disabled = "disabled";
        _inputBox.appendChild(_textarea);
        theAppBox.appendChild(_inputBox);

        const _btn = sue.apps.domCreate(
            "button",
            { setName: ["className"], setValue: ["qr_btn"] },
            null,
            null,
            null,
        ...
        const _outputBox = sue.apps.domCreate("div", {
                setName: ["className"],
                setValue: ["qr_outputbox"],
            }),
            _outputDiv = sue.apps.domCreate("div", {
                setName: ["className"],
                setValue: ["qr_output"],
            });
        ...
        if (
            sue.apps.qr.drawtype &&
            (sue.apps.qr.drawtype[0] == "drg" || sue.apps.qr.drawtype[0] == "sdrg") &&
            sue.apps.qr.seltxt
        ) {
...
chrome.runtime.sendMessage({ type: "apps_getvalue", apptype: "qr" }, response => {
