...
sue.apps.tbkjx = {
    ...
    initUI: function () {
        ...
        const boxContent = sue.apps.domCreate("div", {
            setName: ["className"],
        ...
        const boxList = sue.apps.domCreate("div", {
                setName: ["className"],
        ...
        const boxSearch = sue.apps.domCreate("div", {
            setName: ["className"],
            setValue: ["su_tbkjx_boxsearch"],
        });
        boxSearch.appendChild(
            sue.apps.domCreate(
                "input",
                {
        ...
        boxSearch.appendChild(
            sue.apps.domCreate("button", { setName: ["id"], setValue: ["su_tbkjx_search"] }, null, null, null, "搜索")
        );

        const headSort = sue.apps.domCreate("div", {
            setName: ["className"],
            setValue: ["su_tbkjx_sort"],
        });
        const _sortReset = sue.apps.domCreate(
                "button",
                {
                    setName: ["className"],
        ...
        const headPlatform = sue.apps.domCreate("div", {
            setName: ["className"],
            setValue: ["su_tbkjx_platform"],
        });
        const _platformAll = sue.apps.domCreate(
                "button",
                {
                    setName: ["className"],
                ...
                null,
                null,
                { setName: ["platform"], setValue: ["0"] },
                "所有平台"
            ),
            _platformTaobao = sue.apps.domCreate(
                "button",
                {
                    setName: ["className"],
                ...
                null,
                "margin:0 5px;",
                { setName: ["platform"], setValue: ["1"] },
                "淘宝"
            ),
            _platformTianmao = sue.apps.domCreate(
                "button",
                {
                    setName: ["className"],
        ...
        const headExtent = sue.apps.domCreate("div", {
            setName: ["className"],
            setValue: ["su_tbkjx_extent"],
        });
        const _extentSpan = sue.apps.domCreate(
                "span",
                { setName: ["className"], setValue: ["su_tbkjx_extentspan"] },
                null,
                null,
                null,
                "价格范围："
            ),
            _extentFrom = sue.apps.domCreate(
                "input",
                {
            ...
            _extentDash = sue.apps.domCreate(
                "span",
                { setName: ["className"], setValue: ["su_tbkjx_extenttext"] },
                null,
                "font-size:10px;",
                null,
                "~"
            ),
            _extentTo = sue.apps.domCreate(
                "input",
                {
                    setName: ["className", "id", "placeholder", "type"],
        ...
        const _bottomPre = sue.apps.domCreate(
                "button",
                {
            ...
            _bottomHome = sue.apps.domCreate(
                "button",
                {
                    setName: ["id", "className", "title"],
                ...
                { setName: ["page"], setValue: ["0"] },
                "□"
            ),
            _bottomNext = sue.apps.domCreate(
                "button",
                {
                    setName: ["id", "className", "title"],
            ...
            _bottomDes = sue.apps.domCreate(
                "div",
                { setName: ["className"], setValue: ["su_tbkjx_des"] },
                null,
                null,
                null,
                "只买需要的，不买便宜的(*^_^*)"
        ...
        const _infoBox = sue.apps.domCreate("div", {
                setName: ["className"],
        ...
        _info.appendChild(
            sue.apps.domCreate(
                ...
                null,
                null,
                "1、每日更新上万款优惠券商品，购物前可以从这里搜索是否有和心意的。"
            )
        );
        _info.appendChild(
            sue.apps.domCreate("li", null, null, null, null, "2、由于商家调价等因素，部分商品价格可能有变动。")
        );
        _info.appendChild(
            sue.apps.domCreate(
                "li",
                ...
                null,
                null,
                "3、点击商品图片显示领券地址的二维码。可以通过手机淘宝扫码在手机上领券购买！"
            )
        );
        _info.appendChild(sue.apps.domCreate("li", null, null, null, null, "4、理性购物，多多比较，购买需要的物品。"));
        const _li = sue.apps.domCreate("li", null, null, null, null, "5、此迷你应用也有相应的网页版本：");
        const _a = sue.apps.domCreate(
            "a",
            {
                setName: ["href", "target"],
    ...
    itemInit: data => {
        const _dom = sue.apps.tbkjx.dom.querySelector(".su_main .su_tbkjx_boxcontent");
        _dom.textContent = "";
        // let _img=sue.apps.domCreate("img",{setName:["className","src"],setValue:["su_tbkjx_img",data[1]]}),
        const _img = sue.apps.domCreate(
                "div",
                {
                ...
                null,
                "background-image:url(" + data[1] + ");background-size:contain"
            ),
            _name = sue.apps.domCreate(
                "div",
                {
                    setName: ["className", "title"],
                ...
                null,
                null,
                DOMPurify.sanitize(data[0])
            ),
            _spanPrice = sue.apps.domCreate(
                "span",
                {
                    setName: ["className"],
                ...
                null,
                null,
                { setName: ["link"], setValue: [DOMPurify.sanitize(data[3])] },
                "券后价"
            ),
            _price = sue.apps.domCreate(
                "span",
                { setName: ["className"], setValue: ["su_tbkjx_price su_tbkjx_open"] },
                null,
                null,
                { setName: ["link"], setValue: [DOMPurify.sanitize(data[3])] },
                "￥" + DOMPurify.sanitize(data[2])
            ),
            _buy = sue.apps.domCreate(
                "span",
                { setName: ["className"], setValue: ["su_tbkjx_buy su_tbkjx_open"] },
                null,
                null,
                { setName: ["link"], setValue: [DOMPurify.sanitize(data[3])] },
                "前往领券(￥" + DOMPurify.sanitize(data[4]) + ")"
            ),
            _btnBox = sue.apps.domCreate(
                "button",
                { setName: ["className"], setValue: ["su_tbkjx_btnbox su_tbkjx_open"] },
                null,
                null,
                { setName: ["link"], setValue: [DOMPurify.sanitize(data[3])] }
            );
        ...
        const _domQr = sue.apps.domCreate(
            "div",
            { setName: ["className"], setValue: ["su_tbkjx_qr"] },
            null,
            "display:none;"
        );
    ...
    initList: (data, page) => {
        ...
        ////
        const _listLength = sue.apps.tbkjx.config.n_num;
        const _page = page;
        const _pagePre = _page == "0" ? "-1" : page - 1,
            _pageNext = _page == Number.parseInt(data.length / _listLength) ? "-1" : Number(_page) + 1;
        ...
        _pagePre == -1
            ? (sue.apps.tbkjx.dom.querySelector("#su_tbkjx_btnpre").disabled = true)
            : (sue.apps.tbkjx.dom.querySelector("#su_tbkjx_btnpre").disabled = false);
        _pageNext == -1
            ? (sue.apps.tbkjx.dom.querySelector("#su_tbkjx_btnnext").disabled = true)
            : (sue.apps.tbkjx.dom.querySelector("#su_tbkjx_btnnext").disabled = false);

        sue.apps.tbkjx.dom.querySelector(".su_tbkjx_boxlist").scrollIntoView();

        ////
        const _dom = sue.apps.tbkjx.dom.querySelector(".su_tbkjx_listjing");
        _dom.textContent = "";
        const _listUL = sue.apps.domCreate("ul");
        ...
        for (var i = 0; i < data.length; i++) {
            _listUL.appendChild(
                sue.apps.domCreate(
                    ...
                    null,
                    null,
                    { setName: ["id"], setValue: [i + _page * _listLength] },
    ...
    handleEvent: e => {
        switch (e.type) {
            case "click":
                ...
                if (
                    e.target.classList.contains("su_tbkjx_img") ||
                    (e.target.parentNode && e.target.parentNode.classList.contains("su_tbkjx_qr"))
                ) {
    ...
    platformBtn: () => {
        const platformBtns = sue.apps.tbkjx.dom.querySelectorAll(".su_tbkjx_platformbtn");
    ...
    itemSearch: () => {
        const _dom = sue.apps.tbkjx.dom;
        _dom.querySelector("#su_tbkjx_extentfrom").value = "";
        _dom.querySelector("#su_tbkjx_extento").value = "";

        const data = sue.apps.tbkjx.cons.data;
        const _keys = _dom.querySelector("#su_tbkjx_searchkey").value.split(" ");
        const _newD = [];
        const arrayDiff = arr => {
            const result = [];
            const obj = {};
        ...
        const newData = arrayDiff(concatArray);
    ...
    itemSwitch: ele => {
        ...
        const items = ele.parentNode.querySelectorAll("li");
    ...
    setSortBtn: () => {
        ...
        const _btns = sue.apps.tbkjx.dom.querySelectorAll(".su_tbkjx_sortbtn");
    ...
    itemExtent: () => {
        const _dom = sue.apps.tbkjx.dom;
        const _from = Number(_dom.querySelector("#su_tbkjx_extentfrom").value),
...
chrome.runtime.sendMessage({ type: "apps_getvalue", apptype: "tbkjx" }, response => {
