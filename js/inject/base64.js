...
sue.apps.base64 = {
    ...
    initUI: function () {
        ...
        const _str = sue.apps.domCreate("div", {
                setName: ["className"],
                setValue: ["base_str"],
            }),
            _textStr = sue.apps.domCreate(
                "textarea",
                { setName: ["className"], setValue: ["base_areastr"] },
                null,
                null,
                null,
                "dGVzdA=="
            ...
            _btnEncode = sue.apps.domCreate(
                "button",
                { setName: ["className"], setValue: ["base_btn_encode"] },
                null,
                null,
                null,
                sue.apps.i18n("btn_encode")
            ),
            _btnDecode = sue.apps.domCreate(
                "button",
                { setName: ["className"], setValue: ["base_btn_decode"] },
                null,
                null,
                null,
                sue.apps.i18n("btn_decode")
            );
        const _code = sue.apps.domCreate("div", {
                setName: ["className"],
                setValue: ["base_code"],
            }),
            _textCode = sue.apps.domCreate("textarea", {
                setName: ["className"],
                setValue: ["base_areacode"],
            }),
            _brCode = sue.apps.domCreate("br"),
            _btnBack = sue.apps.domCreate(
                "button",
                { setName: ["className"], setValue: ["base_btn_back"] },
                null,
                null,
                null,
                sue.apps.i18n("btn_back")
            );
        const _copyright = sue.apps.domCreate(
                "div",
                { setName: ["className"], setValue: ["su_copyright"] },
                null,
                null,
                null,
                "Based on "
