...
sue.apps.savepdf = {
    ...
    initUI: () => {
        ...
        const _optBox = sue.apps.domCreate("div", {
                setName: ["className"],
                setValue: ["su_options"],
            }),
            ...
            _optBtn = sue.apps.domCreate(
                "button",
                { setName: ["className"], setValue: ["options_btn_reset"] },
                null,
                null,
                null,
                sue.apps.i18n("btn_reset")
            );
    ...
    initOptions: pdfConf => {
        const theAppBox = sue.apps.savepdf.dom.querySelector(".savepdfbox");
        ...
        const _btnBox = sue.apps.domCreate("div", {
            ...
            _btn = sue.apps.domCreate(
                "button",
                { setName: ["className"], setValue: ["su_savepdf_btn"] },
                null,
                null,
                null,
                "Generate PDF"
        ...
        const _spanOri = sue.apps.domCreate(
                "span",
                { setName: ["className"], setValue: ["su_savepdf_span"] },
                null,
                null,
                null,
                sue.apps.i18n("savepdf_" + "orientation")
            ),
            _selectOri = sue.apps.domCreate("select", {
                setName: ["className", "name"],
                setValue: ["pdfele", "savepdf_orientation"],
            });
        const _optionOri_0 = sue.apps.domCreate(
                "option",
                { setName: ["value"], setValue: ["0"] },
                null,
                null,
                null,
                sue.apps.i18n("savepdf_" + "portrait")
            ),
            _optionOri_1 = sue.apps.domCreate(
                "option",
                { setName: ["value"], setValue: ["1"] },
                null,
                null,
                null,
                sue.apps.i18n("savepdf_" + "landscape")
            );
        ...
        const _spanPap = sue.apps.domCreate(
                "span",
                { setName: ["className"], setValue: ["su_savepdf_span"] },
                null,
                null,
                null,
                sue.apps.i18n("savepdf_" + "paperSizeUnit")
            ),
            _selectPap = sue.apps.domCreate("select", {
                setName: ["className", "name"],
                setValue: ["pdfele", "savepdf_paperSizeUnit"],
            });
        const _optionPap_0 = sue.apps.domCreate(
                "option",
                { setName: ["value"], setValue: ["0"] },
                null,
                null,
                null,
                sue.apps.i18n("savepdf_" + "inches")
            ),
            _optionPap_1 = sue.apps.domCreate(
                "option",
                { setName: ["value"], setValue: ["1"] },
                null,
                null,
                null,
                sue.apps.i18n("savepdf_" + "millimeters")
            );
        ...
        const _arrayCheck = ["showBackgroundColors", "showBackgroundImages", "shrinkToFit"];
        for (var i = 0; i < _arrayCheck.length; i++) {
            var _check = sue.apps.domCreate("input", {
                setName: ["className", "id", "type", "checked"],
                setValue: [
                    "pdfele su_savepdf_text",
                    "savepdf_" + _arrayCheck[i],
                    "checkbox",
                    pdfConf[_arrayCheck[i]] ? " checked" : "",
                ],
            });
            var _label = sue.apps.domCreate(
                ...
                null,
                null,
                sue.apps.i18n("savepdf_" + _arrayCheck[i])
            );
        ...
        const _arrayText = ["footerCenter", "footerLeft", "footerRight", "headerCenter", "headerLeft", "headerRight"];
        for (var i = 0; i < _arrayText.length; i++) {
            var _spanText = sue.apps.domCreate(
                "span",
                { setName: ["className"], setValue: ["su_savepdf_span"] },
                null,
                null,
                null,
                sue.apps.i18n("savepdf_" + _arrayText[i])
            );
            var _text = sue.apps.domCreate(
                "input",
                {
                    setName: ["className", "id", "type", "placeholder", "value"],
                    setValue: [
                        "pdfele su_savepdf_text",
                        "savepdf_" + _arrayText[i],
                        "text",
                        sue.apps.i18n("place_string"),
                        pdfConf[_arrayText[i]],
                    ],
                },
                null,
                null,
                { setName: ["type"], setValue: ["string"] }
            );
        ...
        for (var i = 0; i < _arrayText_Num.length; i++) {
            var _spanText = sue.apps.domCreate(
                ...
                null,
                null,
                sue.apps.i18n("savepdf_" + _arrayText_Num[i])
            );
            var _text = sue.apps.domCreate(
                "input",
                {
                    ...
                    setValue: [
                        "pdfele su_savepdf_text",
                        "savepdf_" + _arrayText_Num[i],
                        "text",
                        sue.apps.i18n("place_number"),
                        pdfConf[_arrayText_Num[i]] /**/,
                    ],
                },
                null,
                null,
                { setName: ["type"], setValue: ["number"] }
            );
            theAppBox.appendChild(_spanText);
            theAppBox.appendChild(_text);
            theAppBox.appendChild(sue.apps.domCreate("br"));
    ...
    pdf: e => {
        let pdfData = {},
            ...
            i = 0;
        const pdfDoms = pdfDom.querySelectorAll(".pdfele");
    ...
    randnum: e => {
        ...
        var randLength = Number.parseInt(domsavepdf.querySelector("#num").value),
            min = Number.parseInt(domsavepdf.querySelector("#min").value),
            max = Number.parseInt(domsavepdf.querySelector("#max").value),
        ...
        for (var i = 0; i < randLength; i++) {
            var num = Number.parseInt(Math.savepdf() * (max - min + 1) + min - (min < 0 ? 1 : 0));
            for (var ii = 0; norepeat && ii < nums.length; ii++) {
                if (num == nums[ii]) {
                    flag = true;
                    return sue.apps.savepdf.randnum(e);
                }
            }
            nums.push(num);
        }
